 ...
 */
	if ( ! class_exists('Livre_500px_Photo_Grid')) {
		class Livre_500px_Photo_Grid extends WP_Widget {
...
if ( ! function_exists( 'Livre_500px_Photo_Grid_init' ) && class_exists( 'Livre_500px_Photo_Grid' ) ) {
	function Livre_500px_Photo_Grid_init() {
		register_widget('Livre_500px_Photo_Grid');
	}
	add_action('widgets_init', 'Livre_500px_Photo_Grid_init');
}