 ...
 */
 class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control {
	...
	*/
	 ...
	 * @return String
	 */
	public function get_fonts( $amount = 5000, $api_key = '' ) {
		if ( empty( $api_key ) && defined( 'TOKOO_VITAMINS_GOOGLE_FONTS_API_KEY' ) ) {
			$api_key = TOKOO_VITAMINS_GOOGLE_FONTS_API_KEY;
		}

		$api_key = apply_filters( 'tokoo_vitamins_google_fonts_api_key', $api_key );
