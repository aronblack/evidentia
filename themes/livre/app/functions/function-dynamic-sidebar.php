 ...
 * @author tokoo
 **/
function livre_maybe_has_sidebar_left() {

	$page_layout 	= theme_layouts_get_layout();
	$get_sidebar 	= livre_get_meta( '_layouts_details' );
 ...
 * @author tokoo
 **/
function livre_maybe_has_sidebar_right() {
 ...
 * @author tokoo
 **/
function livre_maybe_has_sidebar( $default = 'livre-primary' ) {
