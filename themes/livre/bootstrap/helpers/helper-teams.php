 ...
 * @author tokoo
 **/
function livre_team_get_role() {
	$meta 	= get_post_meta( get_the_ID(), 'livre_team_details', true );
 ...
 * @author tokoo
 **/
function livre_team_get_social_account_array() {
	$meta 			= get_post_meta( get_the_ID(), 'livre_team_details', true );
 ...
 * @author tokoo
 **/
function livre_team_social_accounts() {
	$meta 				= get_post_meta( get_the_ID(), 'livre_team_details', true );
 ...
 * @author tokoo
 **/
function livre_team_get_biography() {
	$meta 		= get_post_meta( get_the_ID(), 'livre_team_details', true );
 ...
 * @author tokoo
 **/
function livre_team_get_skills_array() {
	$meta 	= get_post_meta( get_the_ID(), 'livre_team_details', true );
