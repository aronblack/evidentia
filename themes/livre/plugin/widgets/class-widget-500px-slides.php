 ...
 */
	if ( ! class_exists('Livre_500px_Photo_Slides')) {
		class Livre_500px_Photo_Slides extends WP_Widget {
...
if ( ! function_exists( 'Livre_500px_Photo_Slides_init' ) && class_exists( 'Livre_500px_Photo_Slides' ) ) {
	function Livre_500px_Photo_Slides_init() {
		register_widget('Livre_500px_Photo_Slides');
	}
	add_action('widgets_init', 'Livre_500px_Photo_Slides_init');
}