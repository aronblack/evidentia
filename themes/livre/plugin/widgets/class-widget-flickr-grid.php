...
/*	Flicker Gallery
/*-----------------------------------------------------------------------------------*/
	if ( ! class_exists('Livre_Flickr_Photo_Grid') ) {
		class Livre_Flickr_Photo_Grid extends Tokoo_Widget {
			...
			function __construct() {
				...
				$args = array(
					'label' 		=> esc_html__( 'Tokoo - Flickr Photo Grid', 'livre' ),
					'description' 	=> esc_html__( 'A custom widget to display the flickr photo in grid display.', 'livre' ),
				 );
				...
				$args['fields'] = array(
					...
					array(
						...
						'type' 		=> 'text',
						'class' 	=> 'widefat',
						'std' 		=> esc_html__( 'Flickr Photo Grid', 'livre' ),
						'validate' 	=> 'alpha_dash',
			...
			function get_photos( $id, $count = 8 ) {
				...
				$transient_key 	= md5( 'livre_flickr_grid_cache_' . $id . $count );
...
if ( ! function_exists( 'Livre_Flickr_Photo_Grid_init' ) && class_exists( 'Livre_Flickr_Photo_Grid' ) ) {
	function Livre_Flickr_Photo_Grid_init() {
		register_widget('Livre_Flickr_Photo_Grid');
	}
	add_action('widgets_init', 'Livre_Flickr_Photo_Grid_init');
}