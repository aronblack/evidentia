...
/*	Flicker Gallery
/*-----------------------------------------------------------------------------------*/
	if ( ! class_exists('Livre_Flickr_Photo_Slides')) {
		class Livre_Flickr_Photo_Slides extends Tokoo_Widget {
			...
			function __construct() {
				...
				$args = array(
					'label' 		=> esc_html__( 'Tokoo - Flickr Photo Slides', 'livre' ),
					'description' 	=> esc_html__( 'A custom widget to display the flickr photo in slide display.', 'livre' ),
				 );
				...
				$args['fields'] = array(
					...
					array(
						...
						'type' 		=> 'text',
						'class' 	=> 'widefat',
						'std' 		=> esc_html__( 'Flickr Photo Slides', 'livre' ),
						'validate' 	=> 'alpha_dash',
					...
					// Width
					array(
						'name'		=> esc_html__( 'Flickr ID', 'livre' ),
					...
					// Width
					array(
						'name'		=> esc_html__( 'How many photos will be displayed', 'livre' ),
						'id' 		=> 'count',
						'type'		=> 'text',
						'class' 	=> 'widefat',
						'std' 		=> 6,
					...
					// Width
					array(
						'name'		=> esc_html__( 'Thumbnail Width', 'livre' ),
						'id' 		=> 't_width',
						'type'		=> 'text',
						'class' 	=> 'widefat',
						'std' 		=> 80,
					...
					// Width
					array(
						'name'		=> esc_html__( 'Thumbnail Height', 'livre' ),
						'id' 		=> 't_height',
						'type'		=> 'text',
						'class' 	=> 'widefat',
						'std' 		=> 80,
				...
				$this->defaults = apply_filters( 'livre_flickr_widget_modify_defaults', $this->defaults );
			}
			...
			function get_photos( $id, $count = 8 ) {
				...
				$transient_key 	= md5( 'livre_flickr_slides_cache_' . $id . $count );
...
if ( ! function_exists( 'Livre_Flickr_Photo_Slides_init' ) && class_exists( 'Livre_Flickr_Photo_Slides' ) ) {
	function Livre_Flickr_Photo_Slides_init() {
		register_widget('Livre_Flickr_Photo_Slides');
	}
	add_action('widgets_init', 'Livre_Flickr_Photo_Slides_init');
}