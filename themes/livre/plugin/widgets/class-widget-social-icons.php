...
if ( class_exists( 'Tokoo_Widget' ) ) {
	...
	if ( ! class_exists('Livre_Social_Connect')) {
		class Livre_Social_Connect extends WP_Widget {
			...
			function __construct() {
				...
				$widget_ops = array(
					...
					'description' 	=> esc_html__( 'A custom widget to display the social network icons.', 'livre' )
				);
				...
				parent::__construct( 'livre_Social_Connect', esc_html__( 'Tokoo - Social Connect', 'livre' ), $widget_ops, $control_ops );
			...
			function widget( $args, $instance ) {
				...
				<div class="social-links <?php echo esc_attr( $size ) . ' ' . $type; ?>">
					...
					<?php } if ( $ytube_id ) { ?>
						<a class="youtube" href="<?php echo esc_url( 'https://www.youtube.com/user/' . $ytube_id ); ?>" target="_blank"><i class="fa fa-youtube"></i></a>
					<?php } if ( $steam_id ) { ?>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'livre' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e( 'Description:', 'livre' ); ?></label>
			...
			<div class="widget-controls columns-2">
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Type:', 'livre' ); ?></label>
					<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'type' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>">
						<option value="normal" <?php selected( $type, 'normal' ); ?>><?php esc_html_e( 'Normal', 'livre' ); ?></option>
						<option value="boxed" <?php selected( $type, 'boxed' ); ?>><?php esc_html_e( 'Boxed', 'livre' ); ?></option>
						<option value="rounded" <?php selected( $type, 'rounded' ); ?>><?php esc_html_e( 'Rounded', 'livre' ); ?></option>
					</select>
				</p>
			</div>
			<div class="widget-controls columns-2 column-last">
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e( 'Size:', 'livre' ); ?></label>
					<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'size' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>">
						<option value="large" <?php selected( $size, 'large' ); ?>><?php esc_html_e( 'Large', 'livre' ); ?></option>
						<option value="medium" <?php selected( $size, 'medium' ); ?>><?php esc_html_e( 'Medium', 'livre' ); ?></option>
						<option value="small" <?php selected( $size, 'small' ); ?>><?php esc_html_e( 'Small', 'livre' ); ?></option>
					</select>
				</p>
			</div>
			...
			<div class="widget-controls columns-3">
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'fb_id' ) ); ?>"><?php esc_html_e( 'Facebook Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_id' ) ); ?>"><?php esc_html_e( 'Twitter Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'gplus_id' ) ); ?>"><?php esc_html_e( 'Google Plus Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin_id' ) ); ?>"><?php esc_html_e( 'Linkedin Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'spotify_id' ) ); ?>"><?php esc_html_e( 'Spotify Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'codepen_id' ) ); ?>"><?php esc_html_e( 'Codepen Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'digg_id' ) ); ?>"><?php esc_html_e( 'Digg Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'foursquare_id' ) ); ?>"><?php esc_html_e( 'Foursquare Username:', 'livre' ); ?></label>
			...
			<div class="widget-controls columns-3">
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'github_id' ) ); ?>"><?php esc_html_e( 'Github Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'reddit_id' ) ); ?>"><?php esc_html_e( 'Reddit Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'skype_id' ) ); ?>"><?php esc_html_e( 'Skype Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'behance_id' ) ); ?>"><?php esc_html_e( 'Behance Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'ytube_id' ) ); ?>"><?php esc_html_e( 'Youtube Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'steam_id' ) ); ?>"><?php esc_html_e( 'Steam Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'dribbble_id' ) ); ?>"><?php esc_html_e( 'Dribbble Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr_id' ) ); ?>"><?php esc_html_e( 'Tumblr Username:', 'livre' ); ?></label>
			...
			<div class="widget-controls columns-3 column-last">
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'wordpress_id' ) ); ?>"><?php esc_html_e( 'WordPress Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_id' ) ); ?>"><?php esc_html_e( 'Instagram Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_id' ) ); ?>"><?php esc_html_e( 'Pinterest Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'flickr_id' ) ); ?>"><?php esc_html_e( 'Flickr Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo_id' ) ); ?>"><?php esc_html_e( 'Vimeo Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'vine_id' ) ); ?>"><?php esc_html_e( 'Vine Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'deviantart_id' ) ); ?>"><?php esc_html_e( 'Deviantart Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'lastfm_id' ) ); ?>"><?php esc_html_e( 'Last FM Username:', 'livre' ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud_id' ) ); ?>"><?php esc_html_e( 'Soundcloud Username:', 'livre' ); ?></label>
...
if ( ! function_exists( 'Livre_Social_Connect_init' ) && class_exists( 'Livre_Social_Connect' ) ) {
	function Livre_Social_Connect_init() {
		register_widget('Livre_Social_Connect');
	}
	add_action('widgets_init', 'Livre_Social_Connect_init');
}