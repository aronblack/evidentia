	...
	<div class="post__inner">
					...
					if ( $attachments ) { ?>
						...
						<ul class="slides">
							<?php foreach ( $attachments as $key => $attachment ) { ?>
								...
								<?php $small_image = wp_get_attachment_image_src( $attachment->ID, 'livre_blog_list' ); ?>

								<li>
									<a class="tokoo-lightbox" data-gall="post-gallery-<?php the_ID(); ?>" href="<?php echo esc_url( $large_image[0] ); ?>">
									<img src="<?php echo '' . $small_image[0]; ?>" alt="<?php esc_html_e( 'Post Images', 'livre' ); ?>">
			...
			<?php if ( has_post_thumbnail() ) : ?>
				<div class="post__image">
					<a href="<?php the_permalink(); ?>">
						...
						$image_url = wp_get_attachment_image_src( $post_thumbnail_id , 'livre_blog_list' );
						?>		
		...
		<div class="post__detail">
			...
			<div class="post__excerpt">
				...
				<a class="post__more button" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More', 'livre' ); ?></a>
			</div>
		</div>
	</div>
</article>
