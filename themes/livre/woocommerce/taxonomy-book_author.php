					...
					<?php 
					 ...
					 <header class="section-header section-header--center">
						<h2 class="section-title">
							<?php echo apply_filters( 'woocommerce_book_author_info_title', esc_html__( 'Biography', 'livre' ) ); ?>
						</h2>
					</header>
						...
						<?php 
							if ( ! empty( $get_author_img_id ) ) {
								...
								echo '<figure class="author-bio__image">';
									echo '<img src="'.esc_url( $author_picture[0] ).'" alt="'.esc_html__( 'Author Picture', 'livre' ).'">';
								echo '</figure>';
							}
						 ?>
						<div class="author-bio__details">
							<h3 class="author-name"><a href="<?php echo esc_url( get_term_link( $current_object->slug, 'book_author' ) ); ?>"><?php echo esc_attr( $current_object->name ); ?></a></h3>
			...
			<div class="content-area col-md-6" data-sticky_column>
				<article class="page type-page">
					...
					<?php if ( have_posts() ) : ?>
						...
						<header class="section-header section-header--center">
							<h2 class="section-title">
								<?php echo apply_filters( 'woocommerce_book_author_section_title', esc_html__( 'Books Of', 'livre' ) ); ?> <?php single_term_title(); ?>
							</h2>
						</header>
